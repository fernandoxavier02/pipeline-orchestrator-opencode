...
| W5.2 | `src/opencode/spec-seal-guard.cjs` | `.claude/hooks/spec-seal-guard.cjs` (273) | hook `tool.execute.before` para bash | A | bloqueia `run-seal.cjs` se spec_review_done !== true; teste passa |
